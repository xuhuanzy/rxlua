...
test('distinct - 使用比较器去重', function()
    local source = {
        { id = 1, name = "A" },
        { id = 2, name = "B" },
        { id = 1, name = "C" },
...
test('distinct - 使用键选择器去重', function()
    local source = {
        { id = 1, name = "A" },
        { id = 2, name = "B" },
        { id = 3, name = "A" },
...
test('distinct - 使用键选择器和比较器去重', function()
    local source = {
        { id = 1, name = "apple" },
        { id = 2, name = "Banana" },
        { id = 3, name = "Apple" },
...
test('distinct - 对 table 在不使用比较器时发出警告', function()
    local source = {
        { id = 1, name = "A" },
        { id = 2, name = "B" },
